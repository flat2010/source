...
- 求$\max \limits\_{\vec \alpha} \lbrack -\frac{1}{2} \sum\_{i=1}^3 \sum\_{j=1}^3 \alpha\_i \alpha\_j y\_i y\_j (\vec x\_i · \vec x\_j) + \sum\_{i=1}^3 \alpha\_i \rbrack$在限制条件$\alpha\_1 · (+1) + \alpha\_2 · (+1)  + \alpha\_3 · (-1)  = \alpha\_1 + \alpha\_2  - \alpha\_3  = 0$及$\alpha\_1, \ \alpha\_2, \ \alpha\_3 \in [0, \ +\infty] $下的极值；
$$
  \begin{split}
...
$$
  \begin{split}
  \begin{cases}
  \frac{\partial f(\alpha\_1 , \alpha\_2 , \alpha\_3)}{\partial \alpha\_1} = 8 \alpha\_1 + 10 \alpha\_2 = 0 \\\\
  \frac{\partial f(\alpha\_1 , \alpha\_2 , \alpha\_3)}{\partial \alpha\_2} = 13 \alpha\_2 + 10 \alpha\_1 = 0
  \end{cases}
  \end{split}
  \tag{1 - 24}
  $$
  ...
  &emsp;&emsp;虽然求出了解，但是该解中$\alpha\_2$不满足约束$\alpha\_2$
