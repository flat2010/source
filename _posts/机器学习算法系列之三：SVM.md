...
![image](机器学习算法系列之三：SVM/SVM首图.png)
...
![image](机器学习算法系列之三：SVM/官渡之战配图.jpg)   
...
![image](机器学习算法系列之三：SVM/官渡之战决策.png) 
...
![image](机器学习算法系列之三：SVM/曹操阵营决策和.png) 
...
![image](机器学习算法系列之三：SVM/曹操映射二元值.png) 
...
![image](机器学习算法系列之三：SVM/疝气病训练数据集.png) 
...
![image](机器学习算法系列之三：SVM/sigmoid函数图形.png) 
...
![image](机器学习算法系列之三：SVM/sigmoid函数公式.png) 
...
![image](机器学习算法系列之三：SVM/二元分类输入映射.png) 
<div align='center'>图2-3　输入映射示意图</div>   

&emsp;&emsp;映射后的Sigmoid函数表达式如下图2-4所示：     
![image](机器学习算法系列之三：SVM/输入映射后sigmoid函数表达式.png) 
...
![image](机器学习算法系列之三：SVM/最终简化后sigmoid表达式.png) 
...
![image](机器学习算法系列之三：SVM/输出映射分类.png) 
...
![image](机器学习算法系列之三：SVM/最终约定结果.png) 
...
![image](机器学习算法系列之三：SVM/映射后其它表达形式.png) 
<div align='center'>图2-11　向量乘积其它表达形式</div>