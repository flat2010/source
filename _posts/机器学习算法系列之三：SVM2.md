...
&emsp;&emsp;这是一个**凸二次规划/凸优化问题（convex quadratic programming）**，凸优化问题是一个非常经典的问题（也是机器学习当中最常见的优化问题），但是理解SVM不需要太深入的了解凸二次规划问题，那本章末尾就简单介绍下凸二次规划问题，想了解更多的可以参考本系列相关专题，仅供有兴趣的同学参考。
