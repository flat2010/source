...
<img src="拉格朗日对偶问题/首图.png" width="500" height="800" />
...
##### 1.2.3 Lagrange Multiplier + KKT Conditions
...
），上述最优化问题（称为**原始最优化问题**或**原始问题**等价于如下的广义拉格朗日函数的<font color='red'>**极小极大问题**</font>：
$$
...
![图2-1 函数及函数等高线](拉格朗日对偶问题/函数及函数等高线.jpg)
...
![图2-2    最优化函数的三维图](拉格朗日对偶问题/最优化和等高线关系1.jpg)
...
![图2-3    最优化函数的三维图2](拉格朗日对偶问题/最优化和等高线关系2.jpg)
...
![图2-4    等高线和约束曲线投影](拉格朗日对偶问题/最优化和等高线关系3.jpg)
...
#### 2.1.3 梯度与最优化
&emsp;&emsp;光知道目标函数等高线和约束曲线相切还无法完全确定是最大值还是最小值，比如上图的点$d_3$，只看图2-4的话是无法下结论的，因为点$d_3$所在的等高线的Z值完全有可能比点$d_4$的大，从而不可能是最小值。这也是为什么地形图上不但要作出等高线，还要标注好高程。如果不标注高程，那么图2-4所表示的山，既可能是上凸的（对应山尖），也可能是下凹的（对应山坳）。那么函数等高线又用什么来区分呢？答案就是：<font color='red'>**梯度**</font>！
